      ...
      <div id="mobile-menu" className={menuOpen ? 'open' : ''} onClick={(e) => { if (e.target.id === 'mobile-menu') setMenuOpen(false); }}>
        <div id="mobile-drawer">
          ...
          <ul className="mobile-nav-links">
            ...
            <li><a href="#contact" className="mobile-cta" onClick={() => setMenuOpen(false)}><i className="fa-solid fa-phone"></i> যোগাযোগ</a></li>
          </ul>
        </div>
      </div>
          ...
          <div className="hero-inner">
            ...
            <div className="hero-content">
              ...
              <div className="hero-actions reveal reveal-delay-4">
                ...
                <a href="#contact" className="btn-outline"><i className="fa-solid fa-phone anim-wiggle"></i> যোগাযোগ করুন</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="slider-track" id="services-track">
              ...
              <div className="slider-slide">
                <div className="service-card medicine">
                  <div className="service-icon blue"><i className="fa-solid fa-stethoscope anim-pulse"></i></div>
              ...
              <div className="slider-slide">
                <div className="service-card surgery">
                  <div className="service-icon teal"><i className="fa-solid fa-syringe anim-float"></i></div>
                  <h3>সার্জারী সেবা</h3>
            ...
            <div className="fees-inner">
              ...
              <div className="free-section">
                <div className="free-title">
                  <i className="fa-solid fa-hand-holding-heart anim-beat"></i>
                ...
                <div className="appt-card">
                  <div className="appt-header green">
                    ...
                    <div className="appt-info">
                      <div className="appt-info-row">
                        ...
                        <div>প্রতি শুক্রবার<br />
                          <span className="time-badge">সকাল <span className="hl-num">৯</span> টা — সন্ধ্যা <span className="hl-num">৭</span> টা</span>
                        </div>
                      </div>
                      <div className="appt-info-row">
                  ...
                  <div className="appt-body">
                    <form onSubmit={(e) => submitAppointment(e, 'Brahmanbaria')}>
                      ...
                      {/* Name and Age in one line (Compact Row) */}
                      <div className="name-age-row">
                        ...
                        <div className="form-group age-col">
                ...
                <div className="appt-card">
                  <div className="appt-header blue">
                    ...
                    <div className="appt-info">
                      <div className="appt-info-row">
                        <i className="fa-regular fa-clock anim-wiggle"></i>
                        <div>শনি থেকে বৃহস্পতিবার<br />
                          <span className="time-badge">সকাল <span className="hl-num">১০</span> টা — রাত <span className="hl-num">১০</span> টা</span>
                        </div>
                      </div>
                      <div className="appt-info-row">
                        <i className="fa-solid fa-location-dot anim-float"></i>
                        <span>দি চানখারপুল জেনারেল হাসপাতাল, <span className="hl-num">১০/১</span> নবাব কাটারা রোড, চানখারপুল, ঢাকা।</span>
                      </div>
                    </div>
                  </div>
                  <div className="appt-body">
        ...
        <div className="container">
          ...
          <div className="contact-grid">
            <a href="tel:01747745929" className="contact-card green reveal reveal-delay-1">
              <div className="contact-icon green"><i className="fa-solid fa-phone-volume anim-wiggle"></i></div>
            ...
            <a href="tel:01730082888" className="contact-card blue reveal reveal-delay-2">
              <div className="contact-icon blue"><i className="fa-solid fa-phone-volume anim-wiggle"></i></div>
              <div className="contact-card-text">
          ...
          <div className="fb-wrap reveal reveal-delay-3">
            <a href="https://www.facebook.com/share/18d7WA9KaA/" target="_blank" rel="noreferrer" className="fb-btn">
              <i className="fa-brands fa-facebook anim-pulse" style={{ fontSize: '1.3rem' }}></i>
